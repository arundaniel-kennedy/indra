...
<div class="jumbotron boxer box2">
  <a href="<?php echo base_url(); ?>view_gallery" class="btn btn-outline-dark">Cancel Edit</a> <br><br>
  <h4>Edit Gallery</h4><br>

<form enctype="multipart/form-data" action="<?php echo base_url(); ?>alter_gallery/update" method="post">
